...
func Test_ErrorWhenUnableToInitDatabase(t *testing.T) {
	...
	database.initDatabase = func(binaryExtractLocation, runtimePath, dataLocation, runAsUser, username, password, locale string, encoding string, logger *os.File) error {
...
func Test_ErrorWhenCannotStartPostgresProcess(t *testing.T) {
	...
	database.initDatabase = func(binaryExtractLocation, runtimePath, dataLocation, runAsUser, username, password, locale, encoding string, logger *os.File) error {
